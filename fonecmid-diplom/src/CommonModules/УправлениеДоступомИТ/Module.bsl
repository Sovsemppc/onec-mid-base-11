...
Процедура ПриЗаполненииПоставляемыхПрофилейГруппДоступа(ОписанияПрофилей, ПараметрыОбновления) Экспорт
	...
	ОписаниеПрофиля.Идентификатор = "2d73df5f-2eed-47fc-919c-d24449968abe";
	...
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ВыработкаСотрудниковОтчет");
	ОписанияПрофилей.Добавить(ОписаниеПрофиля);

	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя           = "Менеджер";
	ОписаниеПрофиля.Идентификатор = "d11cec61-4a66-4ec7-90d8-3e1db7d3d9ef";
	...
	ОписаниеПрофиля.Идентификатор = "b9f57b13-27a2-49b6-9131-6cde811c0dcc";
	...
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ВыставленныеАктыОтчет");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_Сотрудники");
	ОписанияПрофилей.Добавить(ОписаниеПрофиля);
	
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя           = "КадровикРасчетчик";
	ОписаниеПрофиля.Идентификатор = "03727d8f-a096-4a9b-a8e6-27deb8cace39";
	...
	ОписаниеПрофиля.Роли.Добавить("ВКМ_Сотрудники");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ЗарплатаИОтпускаОтчеты");
	ОписанияПрофилей.Добавить(ОписаниеПрофиля);
